...
import { launchWithSession, isSessionValid, validateSessionOrPrompt } from "./src/session-manager.js";
...
async function autoBookShowing() {
  ...
  try {
    ...
    // Launch browser with persistent session (no login needed)
    logStep(0, "Launching browser with persistent session", 'info');
